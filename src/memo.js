...
export function memoize(fn, equalityFn = defaultEquality) {
  ...
  //current arguments are the arguments being passed - [1, 2, 3] 
    ...
    if(lastArguments && equalityFn(lastArguments, currentArguments)) { //if have last arguments and last arguments and current arguments are equal return last result
      return lastResult;
    }
